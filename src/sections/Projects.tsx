...
export const ProjectsSection = () => {
  return <section className="pb-16 lg:py-24">
    <div className="container">
      ...
      <h2 className="font-serif text-3xl md:5xl text-center mt-6">Featured Projects</h2>
      <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto">See how I transformed repetative tasks into engaging digital experiences.</p>
